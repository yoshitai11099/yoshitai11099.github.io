...
const Works: React.FC = () => {
    ...
    const worksList = [
        ...
        },
        {
            ...
            // about: "モーションキャプチャ技術を用いた力触覚提示デバイスは，現実手動作の多様性と提示可能な力触覚の多様性とがトレードオフの関係にある．そこで，本研究ではユーザの現実手指を多少動かせる程度に半拘束した状態下での運動意図を取得・反映するインタフェースを提案する．具体的には，モーションキャプチャ技術にみられる1対1マッピングではなく，ユーザの現実手指の運動特性を入力としたアバタ手指制御手法を用いる．これにより，現実手指を定位置付近にとどめつつ，操作性や自己投射性を担保でき，トレードオフを払拭できると考えている．",
            ...
            reference3:"▫️ 吉田大葵，田川和義，半拘束型力触覚デバイスのための手指操作範囲拡張インタフェースの提案，第30回日本バーチャルリアリティ学会大会論文集，3C1-10，Sep.2025"
        }
    ];
                    ...
                    <ul style={{ lineHeight: "1.5" }}>
                        {worksList.map((works, index) => (
                            <div key={index} style={{ fontSize: '15px' }}>
                                ...
                                <p style={{ fontSize:'10px',marginRight: '20px' }}>{works.reference3}</p>
